...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2025 at 02:08 PM
...
CREATE TABLE `tutors` (
  ...
  `email` varchar(255) NOT NULL,
  `profile_photo` varchar(255) NOT NULL DEFAULT '1.jpg',
  `tutor_level` varchar(15) NOT NULL DEFAULT 'G06',
  `password` varchar(255) NOT NULL,
  `registration_date` date NOT NULL,
...
INSERT INTO `tutors` (`tutor_id`, `first_name`, `last_name`, `email`, `profile_photo`, `tutor_level`, `password`, `registration_date`, `educational_qualifications`, `current_points`, `sessions_done`, `is_approved`, `availability_status`, `bio`, `phone_number`, `address`, `total_earnings`) VALUES
(1, 'Tom Parker', '', 'tom@example.com', '1.jpg', 'G06', 'pass123', '2023-01-05', 'B.Ed, M.Ed', 500, 15, 1, 'offline', NULL, NULL, NULL, 0.00),
(2, 'Sara Evans', '', 'sara@example.com', '1.jpg', 'G06', 'pass456', '2023-01-12', 'B.A. in Math', 300, 10, 1, 'offline', NULL, NULL, NULL, 0.00),
(3, 'Mark Allen', '', 'mark@example.com', '1.jpg', 'G06', 'pass789', '2023-01-20', 'M.Sc. in Physics', 150, 5, 0, 'offline', NULL, NULL, NULL, 0.00),
(4, 'Emily Thomas', '', 'emily@example.com', '1.jpg', 'G06', 'pass012', '2023-02-05', 'B.A. in English', 200, 8, 1, 'offline', NULL, NULL, NULL, 0.00),
(5, 'Nathan Baker', '', 'nathan@example.com', '1.jpg', 'G06', 'pass345', '2023-02-10', 'M.A. in History', 400, 12, 0, 'offline', NULL, NULL, NULL, 0.00),
(6, 'Sophie Edwards', '', 'sophie@example.com', '1.jpg', 'G06', 'pass678', '2023-02-20', 'M.A. in Literature', 450, 14, 1, 'offline', NULL, NULL, NULL, 0.00),
(7, 'Chris Jones', '', 'chris@example.com', '1.jpg', 'G06', 'pass901', '2023-03-01', 'B.Ed', 300, 11, 1, 'offline', NULL, NULL, NULL, 0.00),
(8, 'Laura Scott', '', 'laura@example.com', '1.jpg', 'G06', 'pass234', '2023-03-10', 'M.Sc. in Chemistry', 100, 3, 0, 'offline', NULL, NULL, NULL, 0.00),
(9, 'Mike Turner', '', 'mike@example.com', '1.jpg', 'G06', 'pass567', '2023-03-15', 'B.A. in Geography', 350, 9, 1, 'offline', NULL, NULL, NULL, 0.00),
(10, 'Anna Mitchell', '', 'anna@example.com', '1.jpg', 'G06', 'pass890', '2023-04-01', 'Ph.D. in Biology', 600, 18, 1, 'offline', NULL, NULL, NULL, 0.00),
(11, 'James Ross', '', 'james@example.com', '1.jpg', 'G06', 'pass1234', '2023-04-10', 'B.A. in Psychology', 200, 6, 0, 'offline', NULL, NULL, NULL, 0.00),
(12, 'Lucy Morgan', '', 'lucy@example.com', '1.jpg', 'G06', 'pass5678', '2023-04-15', 'M.Sc. in Statistics', 320, 8, 1, 'offline', NULL, NULL, NULL, 0.00),
(13, 'Oliver Wood', '', 'oliver@example.com', '1.jpg', 'G06', 'pass9012', '2023-05-01', 'Ph.D. in Math', 500, 15, 1, 'offline', NULL, NULL, NULL, 0.00),
(14, 'Sophia Nelson', '', 'sophia@example.com', '1.jpg', 'G06', 'pass3456', '2023-05-10', 'B.Sc. in Physics', 250, 10, 1, 'offline', NULL, NULL, NULL, 0.00),
(15, 'Jackie Rogers', '', 'jackie@example.com', '1.jpg', 'G06', 'pass7890', '2023-05-15', 'M.Ed in English', 400, 12, 1, 'offline', NULL, NULL, NULL, 0.00);
...
('Diamond', 'Qualification: Qualification: Qualification: Qualification: Qualification: Degree Holding School Tea', '1000', '#b3ffb366', 'G01'),
('Platinum', 'Qualification: Qualification: Junior Teachers,Trainee Teachers,Post Graduates', '900', '#ffff8066', 'G02'),
('Gold', 'Qualification: Experienced Undergraduate,Trainee Teachers', '800', '#B0E0E666', 'G03'),
('Silver', 'Qualification: Undergraduates', '700', '#FAF9F6', 'G04'),
('Bronze+', 'Qualification: Diploma Holders', '600', '#FAF9F6', 'G05'),
('Bronze', 'Qualification: Post AL Students / Other', '500', '#FAF9F6', 'G06');
...
ALTER TABLE `tutors`
  ...
  ADD UNIQUE KEY `email` (`email`),
  ADD KEY `fk_tutors_grading` (`tutor_level`);

--
-- Indexes for table `tutor_grading`
--
ALTER TABLE `tutor_grading`
...
--
ALTER TABLE `tutors`
  ADD CONSTRAINT `fk_tutors_grading` FOREIGN KEY (`tutor_level`) REFERENCES `tutor_grading` (`grade_id`) ON DELETE CASCADE ON UPDATE CASCADE;
